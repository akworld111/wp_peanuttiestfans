...
<?php else: ?>
    ...
    echo '<div class="upload_form__need_login"><p>You must be logged to upload a photo to the contest. <a href="" class="xoo-el-login-tgr">Login</a> or <a href="" class="xoo-el-reg-tgr">register</a>.</p></div>';
