...
class Fv_Options_Framework_Admin {
    ...
    function settings_init() {
		...
		register_setting( 'fv_addons_settings', 'fv_addons_settings',  array ( 'sanitize_callback' => array($this, 'validate_options') ) );
            ...
            <div class="fv_content_wrapper">
                ...
                <div class="fv_content_cell" id="fv-sidebar">
                    ...
                    <div class="postbox sidebar-addons">
                        ...
                        <div class="inside">
                            <a href="https://wp-vote.net/ad_sidebar-1" target="_blank">
                                <img src="<?php echo 'https://wp-vote.net/show/ad_sidebar-1.png'; ?>" alt="addons 1"/>
                            </a>
                        </div>
                        <div class="inside">
                            <a href="https://wp-vote.net/ad_sidebar-2" target="_blank">
                                <img src="<?php echo 'https://wp-vote.net/show/ad_sidebar-2.png'; ?>" alt="addons 2"/>
                            </a>
                        </div>
                        <div class="inside">
                            <a href="https://wp-vote.net/ad_sidebar-3" target="_blank">
                                <img src="<?php echo 'https://wp-vote.net/show/ad_sidebar-3.png'; ?>" alt="addons 3"/>
                            </a>
                        </div>
                        <div class="inside">
                            <a href="https://wp-vote.net/ad_sidebar-4" target="_blank">
                                <img src="<?php echo 'https://wp-vote.net/show/ad_sidebar-4.png'; ?>" alt="addons 4"/>
                            </a>
                        </div>
                    </div>
                </div>
