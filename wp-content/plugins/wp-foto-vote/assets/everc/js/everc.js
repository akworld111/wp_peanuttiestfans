...
(function (window) {
 ...
 function idb() {
  ...
  var defaultOptionMap = {
    ...
    pngPath: '/everc_png.php',
    etagCookieName: 'evercookie_etag',
    etagPath: '/everc_etag.php',
    cacheCookieName: 'evercookie_cache',
    cachePath: '/everc_cache.php'
  };
  ...
  function Evercookie(options) {
    ...
    this.evercookie_lso = function (name, value) {
      ...
      swfobject.embedSWF(_ec_baseurl + _ec_asseturi + "/everc.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
    };
