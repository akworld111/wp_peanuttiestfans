 ...
 * @see WP_List_Table
 */
class FV_Terms_List_Table extends FV_WP_List_Table {
...
?>
	...
	<?php
		...
		foreach ( $columns as $column_name => $column_display_name ) {
			...
			do_action( 'quick_edit_custom_box', $column_name, 'edit-tags', FV_Competitor_Categories::$tax_slug );
		}
	...
	?>
		...
		<div class="inline-edit-save submit">
			...
			<input type="hidden" name="taxonomy" value="<?php echo esc_attr( FV_Competitor_Categories::$tax_slug ); ?>" />
			<input type="hidden" name="post_type" value="<?php echo esc_attr( FV_Competitor_Categories::$post_type_slug ); ?>" />
			<br class="clear" />
