 ...
 * @since 2.3.00
 */
class FV_Trigger_To_User__Uploaded extends Notification\Abstracts\Trigger {
    ...
    public function __construct() {
        ...
        parent::__construct(
            'fv/competitor/to-user/uploaded',
            __( '*Competitor* successful submitted', 'fv' )
        );
        ...
        $this->add_action( 'fv/notification/competitor/to-user/uploaded', 10, 2 );
