 ...
 * @since 2.3.00
 */
class FV_Trigger_To_User__Deleted extends Notification\Abstracts\Trigger {
    ...
    public function __construct() {
        ...
        parent::__construct(
            'fv/competitor/to-user/deleted',
            __( '*Competitor* has been deleted', 'fv' )
        );
        ...
        $this->add_action( 'fv/notification/competitor/to-user/deleted', 10, 3 );
        ...
        $this->set_description(
            'Fires when admin delete competitor from Moderation page'
        );
