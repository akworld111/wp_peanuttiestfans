...
if (!function_exists('fv_dismissible_notice')) {
    ...
    function fv_dismissible_notice($key, $message, $type = 'info', $required_capability = 'manage_options', $save_state_to = 'option')
    {
        FV_Admin_Dismissible_Notice::get()->enqueue($key, $message, $type, $required_capability, $save_state_to);
    }
}
