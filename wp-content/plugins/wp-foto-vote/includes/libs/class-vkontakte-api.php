...
/**
 * @see https://github.com/bocharsky-bw/vkontakte-php-sdk
 *
...
class Vkontakte
{
    ...
    public function api($method, array $query = array())
    {
        ...
        $result = json_decode($this->curl_wp($url), true);
     ...
     * @throws \Exception
     */
    protected function curl_wp($url)
    {
        $result = false;
        ...
        if ( is_array( $response ) && ! is_wp_error( $response ) ) {
            ...
            fv_log( "Error dutin VK loing:", $response );
            throw new \Exception("Error dutin VK loing:", $response);
        }
     ...
     * @throws \Exception
     */
    protected function curl_old($url)
    {
