...
class Xoo_El_Admin_Settings{
	...
	public function __construct(){
		...
		add_action( 'xoo_el_lla-section_section', array( $this, 'lla_section' ) );
		add_action( 'xoo_el_social-login-section_section', array( $this, 'social_login_section' ) );
	...
	/* Advanced google recaptcha section */
	public function recaptcha_section(){
		?>
		<div class="xoo-el-howto-container">
			<a class="xoo-el-howto-toggle">How to?</a>
			<div class="xoo-el-howto-info">
				<ul>
					<li>Signup for google recaptcha "V2" <a target="_blank" href="https://www.google.com/recaptcha/admin">here</a></li>
					<li>Copy & Paste your client & secret key in the settings.</li>
				</ul>
			</div>
		</div>
		<?php
	...
	/* Advanced limit login attempt section */
	public function lla_section(){
		?>
		<div class="xoo-el-howto-container">
			<a class="xoo-el-howto-toggle">How to?</a>
			<div class="xoo-el-howto-info">
				Fully compatible with Limit Login Attempts Reloaded<br>
				Please install the free plugin from <a href="https://wordpress.org/plugins/limit-login-attempts-reloaded/" target="_blank">here</a><br>
				Be careful , do not block yourself :)
			</div>
		</div>
		<?php
	}
	...
	public function social_login_section(){
		?>
		<div class="xoo-el-howto-container">
			<a class="xoo-el-howto-toggle">How to?</a>
			<div class="xoo-el-howto-info">
				<?php if( defined( 'XOO_SL' ) ): ?>
					Please manage your social login settings <a href="?page=xoo-sl" target="_blank">here</a>
				<?php else: ?>
					Please install the social login extension you recieved in the plugin package or download it from <a href="https://wordpress.org/plugins/social-login-woocommerce" target="_blank">here</a>
				<?php endif; ?>
			</div>
		</div>
		<?php
