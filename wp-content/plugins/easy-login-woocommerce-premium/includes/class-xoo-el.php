...
class Xoo_El{
	...
	public function __construct(){
		...
		require_once XOO_EL_PATH.'/xoo-form-fields-fw/xoo-aff.php'; //Field framework
		$this->fields = xoo_aff_fire( 'el' );
		...
		if($this->is_request('frontend')){
			...
			//Compatibility for Social Login
			if( defined( 'XOO_SL' ) ){
				include_once XOO_EL_PATH.'includes/class-xoo-el-social-login.php';
				xoo_el_social_login();
			}
		...
		if($this->is_request('admin')) {
			...
			require_once XOO_EL_PATH.'admin/class-xoo-el-third-party-settings.php';
